...
//Mongoose.connect("mongodb://localhost:27017/StudentsDatabase")

Mongoose.connect("mongodb+srv://student:student@cluster0.4fauv3k.mongodb.net/StudentsDatabase?retryWrites=true&w=majority")
...
app.delete("/delete/data/:id", async function(req, res){
   ...
   // console.log(confirmation)
    ...
    {
        res.send("student Data is Successfully Delete")
    }
    else
    {
